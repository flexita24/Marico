    ...
    <nav className="bg-transparent w-full z-20 top-0 start-0">
      <div className="flex flex-wrap items-center justify-between mx-4 md:mx-8 p-4 ">
        ...
        <div className="flex md:hidden lg:hidden">
          <button
            onClick={toggleMenu}
            className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
          ...
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border rounded-lg bg-transparent md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
            <li>
              ...
              <ul className="absolute mt-2 w-24 bg-white rounded-lg shadow-md hidden">
                <li>
                  <a href="#" className="block py-2 px-4 hover:bg-gray-100">Female</a>
                </li>
                <li>
                  <a href="#" className="block py-2 px-4 text-white hover:bg-gray-100">Male</a>
                </li>
              </ul>
            </li>
            <li>
